...
$data=array(
  ...
  'utmSource'=>isset($_POST['utmSource']) ? $_POST['utmSource'] : 'default',
  'utmMedium'=>isset($_POST['utmMedium']) ? $_POST['utmMedium'] : 'default',
  'utmCampaign'=>isset($_POST['utmCampaign']) ? $_POST['utmCampaign'] : 'default',
  'utmContent'=>isset($_POST['utmContent']) ? $_POST['utmContent'] : 'default',
  'utmTerm'=>isset($_POST['utmTerm']) ? $_POST['utmTerm'] : 'default'
);
